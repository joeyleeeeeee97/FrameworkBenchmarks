...
If you want to visualize them or comparing different results files on bash, here is a [plaintext results parser](https://github.com/joeyleeeeeee97/PlainTextResultsParser)
